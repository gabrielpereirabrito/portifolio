...
/**
 * Toast de conquista — ADR-0019, compromisso 4.
 *
 ...
 *
 * O texto vem do catálogo em `data/easterEggs`, não daqui: este componente
 * não sabe o que existe, só como anunciar.
 */
...
export function ToastConquista({ catalogo }: ToastConquistaProps) {
  ...
  return (
    ...
    >
      {egg && (
        <div className="hud-panel toast-conquista pointer-events-auto relative flex items-start gap-3 bg-panel p-4">
          <Trophy
            size={22}
            weight="fill"
            aria-hidden="true"
